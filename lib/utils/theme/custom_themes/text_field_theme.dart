...
class CustomTextFieldTheme {
  ...
  static InputDecorationTheme inputDecorationTheme = InputDecorationTheme(
    ...
    prefixIconColor:
        ColorConstants.textSecondary, // Default icon color (medium grey)
    suffixIconColor:
        ColorConstants.textSecondary, // Default icon color (medium grey)
    ...
    labelStyle: const TextStyle().copyWith(
      fontSize:
          SizeConstants.fontSizeMd, // Slightly larger, more readable label
      fontWeight: FontWeight.w600,
      color: ColorConstants.textPrimary, // Medium grey for labels
    ),
    // Hint Text Style
    hintStyle: const TextStyle().copyWith(
      fontSize: SizeConstants.fontSizeMd, // Consistent with label
      color: ColorConstants.textSecondary, // Lighter hint text
    ),
    // Error Text Style
    errorStyle: const TextStyle().copyWith(
      fontStyle: FontStyle.normal, // Keep as normal
      color: ColorConstants.error, // Red for errors
    ...
    floatingLabelStyle: const TextStyle().copyWith(
      color: ColorConstants.textSecondary, // Blue when floating
    ...
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(
        SizeConstants.inputFieldRadius,
    ...
    focusedBorder: const OutlineInputBorder().copyWith(
      ...
      borderSide: const BorderSide(
        ...
        color: ColorConstants.primary, // Blue border when focused
      ),
    ),
    ...
    errorBorder: const OutlineInputBorder().copyWith(
      ...
      borderSide: const BorderSide(
        width: 1,
        color: ColorConstants.error, // Red border for error
      ),
    ),
